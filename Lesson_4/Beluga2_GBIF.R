...
# set the woking directory in the folder with beluga_data.rdata and the icon 
...
sea_otter.map.LPI <- ggplot(
  beluga_simp,                               # base data: cleaned occurrence records
...
# Cleaning the dataset based on multiple criteria: data points on land or in far from cluster
...
beluga1 <- dplyr::filter(beluga.pop, ID == "13273")
...
beluga2 <- dplyr::filter(beluga.pop, ID == "2191")
...
beluga3 <- dplyr::filter(beluga.pop, ID %in% c("1950", "4557", "4558"))
